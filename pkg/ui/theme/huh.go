...
func HuhTheme(t *Theme) huh.Theme {
	return huh.ThemeFunc(func(isDark bool) *huh.Styles {
		...
		h.Focused.ErrorIndicator = h.Focused.ErrorIndicator.Foreground(t.Error.TextStyle.GetForeground())
		h.Focused.ErrorMessage = h.Focused.ErrorMessage.Foreground(t.Error.TextStyle.GetForeground())
